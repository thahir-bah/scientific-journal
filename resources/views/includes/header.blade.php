        ...
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    ...
                    @guest
                        <div class="sj-loginarea">
                            <ul class="sj-loging">
                                ...
                                <li><a href="{{ route('register',['type=register']) }}">{{{trans('prs.register')}}}</a></li>
                            </ul>
                        </div>
                    @else
            ...
            <div class="sj-navigationarea">
                <strong class="sj-logo">
                    <!--
                    <a href="{{url('/')}}">
                        <img id="site_logo" src="{{asset(App\SiteManagement::getLogo())}}" alt="International Journal of Computer Ingineering" >
                    </a>
                -->
                    ...
                    <nav id="sj-nav" class="sj-nav navbar-expand-lg">
                        ...
                        <div class="collapse navbar-collapse sj-navigation" id="navbarNav">
                            <ul class="menu-item sj-loging">
                                ...
                                <li><a href="{{url('/about')}}">{{ trans('prs.about') }}</a></li>
                                @if(empty(Auth::user()->id))
                                    <li><a href="{{ route('login',['type=login']) }}">{{ trans('prs.login') }}</a></li>
                                    <li><a href="{{ route('register',['type=register']) }}">{{ trans('prs.register') }}</a></li>
                                @endif
                                <li><a href="{{url('/current')}}">{{ trans('prs.current') }}</a></li>
                                <li><a href="{{url('/announcements')}}">{{ trans('prs.announcements') }}</a></li>
