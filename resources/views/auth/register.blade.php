                                    ...
                                    <div class="row">
                                        <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                            <form method="POST" action="{{ route('register') }}" class="sj-formtheme sj-formregister" id="register_form" @submit="showloading()">
                                                ...
                                                <fieldset>
                                                    <div>
                                                        <input id="name" style="width: 300px;" type="text" class="form-control{{ $errors->has('name') ? 'is-invalid' : '' }}" name="name" value="{{ old('name') }}"
                                                    ...
                                                    <br>
                                                    <div class="">
                                                        <input type="text" style="width: 300px;" name="sur_name" value="{{ old('sur_name') }}" class="form-control{{ $errors->has('sur_name') ? 'is-invalid' : '' }}"
                                                    ...
                                                    <br>
                                                    <div>
                                                        <input id="email" style="width: 300px;" type="email" class="form-control {{ $errors->register->first('email') ? ' is-invalid' : '' }}"  name="email"
                                                    ...
                                                    <br>
                                                    <div>
                                                        <input id="password" style="width: 300px;" type="password" class="form-control{{ $errors->register->first('password') ? ' is-invalid' : '' }}" name="password"
                                                    ...
                                                    <br>
                                                    <div >
                                                        <input id="password-confirm" style="width: 300px;" type="password" class="form-control" name="password_confirmation" placeholder="{{trans('prs.ph_cnfrm_pass')}}" required>
                                                    </div>
