...
<div class="container">
    <div class="row">
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="sj-topbar" style=" margin:0; padding: 0;">
                    ...
                    <?php if(auth()->guard()->guest()): ?>
                        <div class="sj-loginarea">
                            <ul class="sj-loging">
                                ...
                                <li><a href="<?php echo e(route('register',['type=register'])); ?>"><?php echo e(trans('prs.register')); ?></a></li>
                            </ul>
                        </div>
                    <?php else: ?>
            ...
            <div class="sj-navigationarea">
                <strong class="sj-logo">
                    ...
                    <a href="<?php echo e(url('/')); ?>">
                        <img id="site_logo" src="<?php echo e(asset(App\SiteManagement::getLogo())); ?>" alt="International Journal of Computer Ingineering" >
                    </a>
                -->
                ...
                <div class="sj-rightarea">
                    <nav id="sj-nav" class="sj-nav navbar-expand-lg">
                        ...
                        <div class="collapse navbar-collapse sj-navigation" id="navbarNav">
                            <ul class="menu-item sj-loging">
                                <li><a href="<?php echo e(url('/')); ?>"><i class="lnr lnr-home"></i></a></li>
                                <li><a href="<?php echo e(url('/about')); ?>"><?php echo e(trans('prs.about')); ?></a></li>
                                <?php if(empty(Auth::user()->id)): ?>
                                    <li><a href="<?php echo e(route('login',['type=login'])); ?>"><?php echo e(trans('prs.login')); ?></a></li>
                                    <li><a href="<?php echo e(route('register',['type=register'])); ?>"><?php echo e(trans('prs.register')); ?></a></li>
                                <?php endif; ?>
                                <li><a href="<?php echo e(url('/current')); ?>"><?php echo e(trans('prs.current')); ?></a></li>
                                <li><a href="<?php echo e(url('/announcements')); ?>"><?php echo e(trans('prs.announcements')); ?></a></li>
...
<div class="sj-innerbanner" style="background-color: #005680;">
    <div class="container">
        <div class="row">
