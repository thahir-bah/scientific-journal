...
Route::get('/current',function () { if (Schema::hasTable('users')) { return view('current');}})->name('currentArticle');
Route::get('/about',function () { if (Schema::hasTable('users')) { return view('about');}})->name('about');
Route::get('/announcements',function () { if (Schema::hasTable('users')) { return view('announcements');}})->name('announcements');
